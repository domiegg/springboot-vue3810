...
<div>
    <div style="display:flex;">
        ...
        <Poptip transfer trigger="click" placement="right" title="选择学生" width="250">
            <Button icon="md-list">选择学生</Button>
            <div slot="content">
                <Input v-model="searchKey" suffix="ios-search" @on-change="searchDep" placeholder="输入学生名搜索" clearable />
