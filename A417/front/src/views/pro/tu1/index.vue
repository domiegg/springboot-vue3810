<template>
<div>
    <Alert type="success" show-icon banner>课程平均分分析图</Alert>
                ...
                statistic: {
                    title: {
                        ...
                        customHtml: (container, view, datum) => {
                            ...
                            const text = datum ? datum.title : '课程平均分分析图';
                    ...
                    content: {
                        ...
                        customHtml: (container, view, datum, data) => {
                            ...
                            const text = datum ? ` ${datum.value}分` : ` `;
                            // const text = datum ? ` ${datum.value}分` : ` ${data.reduce((r, d) => r + d.value, 0)}分`;
