...
<div class="user-edit">
    <Modal :title="title" v-model="visible" width="90" draggable :mask-closable="type=='0'" ok-text="确认提交" @on-ok="submit">
        ...
        <Form ref="form" :model="form" :rules="formValidate" label-position="top">
            ...
            <Row :gutter="16">
                <Col span="12">
                <FormItem label="奖惩信息" style="width:100%">
                    <Input v-model="form.content1" />
                </FormItem>
                </Col>
                <Col span="12">
                <FormItem label="社会实践" style="width:100%">
                    <Input v-model="form.content2" />
                </FormItem>
                </Col>
            </Row>
            <Row :gutter="16">
                <Col span="12">
                <FormItem label="所属班级" style="width:100%">
